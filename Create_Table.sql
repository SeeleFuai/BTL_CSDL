...
CREATE TABLE ChiTiet_HD_Ban(
    ...
    CONSTRAINT FK_CTHDB_MaSP FOREIGN KEY(MaSP) REFERENCES San_Pham(MaSP),
    CONSTRAINT FK_CTHDB_MaHD FOREIGN KEY(MaHD) REFERENCES Hoa_Don_Ban_Hang(MaHD)
);
GO
...
CREATE TABLE Cung_Cap(
    ...
    CONSTRAINT PK_CungCap PRIMARY KEY (MaNCC, MaSP), -- PK
    CONSTRAINT FK_CC_MaNCC FOREIGN KEY(MaNCC) REFERENCES Nha_Cung_Cap(MaNCC),
    CONSTRAINT FK_CC_MaSP FOREIGN KEY(MaSP) REFERENCES San_Pham(MaSP)
);
GO